...
layui.use('table', function(){
   ...
   table.render({
        ...
        ,cols: [[
            ...
            ,{field:'rulesname', title:'规则名称', width:"7%"}
            ,{field:'clockinnum', title:'打卡次数', width:"5%"}
            ,{field:'amstarttime', title:'上午上班打卡时间', width:"11%"}
            ,{field:'amendtime', title:'上午下班打卡时间', width:"11%"}
            ,{field:'pmstarttime', title:'下午上班打卡时间', width:"11%"}
            ,{field:'pmendtime', title:'下午下班打卡时间', width:"11%"}
            ,{field:'clockiniocation', title:'打卡位置', width:"11%"}
            ,{field:'instructions', title:'备注', width:"8%"}
            ,{field:'name', title:'规则发布人', width:"13%"}
            ,{fixed: 'right', title:'操作', toolbar: '#barDemo', width:"11%"}
        ]]
        ,page:true
        //异步请求响应
        ,url: '/txs/kaoqing/ajaxPageRuleList'
        ,request: {
    ...
    table.on('tool(layTable)', function(obj){
        ...
        if(obj.event === 'detail'){
            ...
            console.log(data.id);
            let url = '/txs/kaoqing/updateRuleOpt?id='+data.id;
            console.log(url);
            x_admin_show('编辑',url);
...
function member_del(id){
	console.log("====="+id);
    let url = "/txs/kaoqing/ruledelete";
