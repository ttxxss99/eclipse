...
layui.use('table', function(){
   ...
   table.render({
        ...
        ,cols: [[
            ...
            ,{field:'situation', title:'情况说明', width:"20%"}
            ,{field:'money', title:'金额', width:"15%"}
            ,{field:'judge', title:'判断', width:"10%"}
            ,{field:'time', title:'奖惩时间', width:"20%"}
            ,{field:'empName', title:'对应员工', width:"16%"}
...
function initTable(situation) {
	layui.use('table', function(){
	   ...
	   table.render({
	        ...
	        ,page:true
	        //异步请求响应
	        ,url: '/rdp/selectLikeAjax?situation='+situation
	        ,request: {
	            pageName: 'pageNum' //页码的参数名称，默认：page
	            ,limitName: 'pageSize' //每页数据量的参数名，默认：limit
	        }
