...
<script type="text/javascript" src="/js/emp/rdpApi.js"></script>
<!-- 让IE8/9支持媒体查询，从而兼容栅格 -->
<!--[if lt IE 9]>
		...
		<div class="layui-row">
			...
			<form class="layui-form layui-col-md12 x-so">
				<div class="layui-inline">
					<label class="layui-form-label" for="situation">奖惩说明</label> <input
						class="layui-input" placeholder="请选择一个奖惩说明" id="situation">
				</div>
		...
		<table class="layui-table" id="layTable" lay-filter="layTable">
			<script type="text/html" id="toolbarDemo">
              <div class="layui-btn-container">
                  ...
                  <button class="layui-btn" onclick="x_admin_show('添加奖惩','/rdp/rdpadd')"><i class="layui-icon"></i>添加</button>
              </div>
          </script>
