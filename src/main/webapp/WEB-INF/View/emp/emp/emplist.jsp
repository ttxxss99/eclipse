		...
		<div class="layui-row">
			...
			<form class="layui-form layui-col-md12 x-so">
				<div class="layui-inline">
					<label class="layui-form-label" for="id">工号:</label> <input
						class="layui-input" placeholder="工号" id="id">
				</div>
				<div class="layui-inline">
					<label class="layui-form-label" for="sex">性别:</label> <input
						class="layui-input" placeholder="性别" id="sex">
				</div>
		...
		<table class="layui-table" id="layTable" lay-filter="layTable">
			<script type="text/html" id="toolbarDemo">
              <div class="layui-btn-container">
                  ...
                  <button class="layui-btn" onclick="x_admin_show('添加用户','/emp/empadd')"><i class="layui-icon"></i>添加</button>
              </div>
          </script>
