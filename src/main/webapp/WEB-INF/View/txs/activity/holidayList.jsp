...
<script type="text/javascript" src="/js/txsjs/holiday.js"></script>
	...
	<div class="x-body">
		...
		<form class="layui-form layui-col-md12 x-so">
			<div class="layui-inline">
				<label class="layui-form-label" for="name">节日名称:</label> <input
					class="layui-input" placeholder="节日名称" id="name">
			</div>
		...
		<table class="layui-table" id="layTable" lay-filter="layTable">
			<script type="text/html" id="toolbarDemo">
              <div class="layui-btn-container">
                  ...
                  <button class="layui-btn" onclick="x_admin_show('添加节日','./holidayAdd')"><i class="layui-icon"></i>添加</button>
              </div>
          </script>
