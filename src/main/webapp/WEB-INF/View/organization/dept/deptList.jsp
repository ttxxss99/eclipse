      ...
      <div class="layui-row">
          <form class="layui-form layui-col-md12 x-so">
              <div class="layui-inline">
                  <label class="layui-form-label" for = "someDeptName">部门名称:</label>
                  <input class="layui-input" placeholder="部门名称" id ="someDeptName">
              </div>
              <div class="layui-inline">
                      <label class="layui-form-label">选择公司</label>
                      <div class="layui-input-inline">
                          <select name="interest" id="selectedCompanyName" lay-filter="aihao">
                              <option value=""></option>
                          </select>
                      </div>
              </div>
      ...
      <table class="layui-table" id="layTable" lay-filter="layTable">
          <script type="text/html" id="toolbarDemo">
              <div class="layui-btn-container">
                  ...
                  <button class="layui-btn" onclick="x_admin_show('添加部门','/organization/dept/deptAdd')"><i class="layui-icon"></i>添加</button>
              </div>
          </script>
