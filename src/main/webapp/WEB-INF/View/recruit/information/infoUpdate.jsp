	...
	<div class="x-body">
		<form class="layui-form" id="form"<%-- action ="/organization/company/addACompany" method="post"--%>>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="hiring" name="hiring" required="" value="${hiring }"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" id="wagebudget" name="wagebudget" required="" value="${wagebudget }"
						lay-verify="required" autocomplete="off" class="layui-input">
				</div>
				<div class="layui-form-mid layui-word-aux">
	...
	<script>
        ...
        layui.use(['form','layer'], function(){
            ...
            form.on('submit(add)', function(data){
                console.log(data);
             $.post("/recruit/info/infoUpdateAjax",{
            	 "id":${id},
            ...
            $.post(url2,
                ...
                (json)=>{
                    ...
                    $("#channelId option[value='"+${channelId}+"']").prop("selected",true);
                    form.render('select'); //刷新select选择框渲染
                    //alert($("#empName option:checked").val())
                }//success end
            )//-------post end
        ...
        $("#logictodelete option[value='"+${logictodelete}+"']").prop("selected",true);
