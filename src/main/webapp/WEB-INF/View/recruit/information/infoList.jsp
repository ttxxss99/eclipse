      ...
      <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so">
			<div class="layui-inline">
			    <label class="layui-form-label" for = "skillsrequired">技能需求:</label>
			    <input class="layui-input" placeholder="技能需求" id ="skillsrequired">
			</div>
      ...
      <table class="layui-table" id="layTable" lay-filter="layTable">
          <script type="text/html" id="toolbarDemo">
              <div class="layui-btn-container">
                  ...
                  <button class="layui-btn" onclick="x_admin_show('添加用户','/recruit/info/infoAdd')"><i class="layui-icon"></i>添加</button>
              </div>
          </script>
...
<script type="text/html" id="logName">
  {{#  if(d.logName === '未删除'){ }}
    <span style="color: #48B727;">{{ d.logName }}</span>
    {{#  } else { }}
    {{ d.logName }}
  {{#  } }}
</script>
