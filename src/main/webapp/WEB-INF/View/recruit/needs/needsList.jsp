      ...
      <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so">
			<div class="layui-inline">
			    <label class="layui-form-label" for = "state">处理状态:</label>
			...
			<div class="layui-inline">
			    <label class="layui-form-label" for = "hiring">需求人数:</label>
			    <input class="layui-input" placeholder="人数" id="hiringMin" value="">-
			    <input class="layui-input" placeholder="人数" id="hiringMax" value="">
			</div>
      ...
      <table class="layui-table" id="layTable" lay-filter="layTable">
          <script type="text/html" id="toolbarDemo">
              <div class="layui-btn-container">
                  ...
                  <button class="layui-btn" onclick="x_admin_show('添加用户','/recruit/needs/needsAdd')"><i class="layui-icon"></i>添加</button>
              </div>
          </script>
...
<script type="text/html" id="stateStr">
  ...
  {{#  } else {d.stateStr === '已处理' }}
    <span style="color: #48B727;">{{ d.stateStr }}</span>
  {{#  } }}
</script>
