      ...
      <table class="layui-table" id="layTable" lay-filter="layTable">
          <script type="text/html" id="toolbarDemo">
              <div class="layui-btn-container">
                  ...
                  <button class="layui-btn" onclick="x_admin_show('添加用户','/recruit/candidate/candidateAdd')"><i class="layui-icon"></i>添加</button>
				  <button class="layui-btn layui-btn-warm " onclick="sendSome()"><i class="layui-icon ">&#xe613;</i>发送Offer</button>
          ...
          <script type="text/html" id="barDemo">
			  ...
			  <a class="layui-btn layui-btn-warm layui-btn-primary layui-btn-xs" lay-event="email" >  <i class="layui-icon ayui-icon-release">offer</i></a>
